    ...
    <div className="space-y-4 sm:space-y-5" id="calendar-section">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between px-1">
        ...
        <div className="flex flex-nowrap items-center gap-2 overflow-x-auto no-scrollbar pb-1 sm:pb-0">
          <div className="flex shrink-0 bg-[var(--ios-surface)]/80 p-1 rounded-[10px] text-[13px] font-bold shadow-sm">
          ...
          <div className="flex shrink-0 bg-[var(--ios-surface)]/80 p-1 rounded-[10px] shadow-sm">
          ...
          <button onClick={syncCalendar} className="w-[38px] h-[38px] shrink-0 flex items-center justify-center rounded-full bg-[var(--ios-surface)]/80 cursor-pointer active:scale-90 transition-transform shadow-sm" title="Cập nhật">
