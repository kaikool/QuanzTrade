    ...
    <div className="space-y-6" id="dashboard-view">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <button onClick={() => setIsSettingsOpen(true)} className="h-10 px-5 bg-[var(--ios-surface)]/80 text-[var(--ios-label)] rounded-full text-[15px] font-semibold flex items-center gap-2.5 cursor-pointer active:scale-95 transition-transform shadow-sm">
