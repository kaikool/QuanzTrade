...
export function IOSTabBar({ currentTab, setCurrentTab }: IOSTabBarProps) {
  return (
    <nav
      id="ios-bottom-nav"
      className="md:hidden fixed z-40 left-3 right-3 flex items-center justify-around px-2 bg-[var(--ios-surface)]/70 border border-[var(--ios-separator)] rounded-[16px] shadow-ios-glass"
      style={{
        bottom: "0.75rem",
        minHeight: "82px",
